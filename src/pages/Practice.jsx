...
function Practice() {
  ...
  const saveToHistory = (scoreData) => {
    ...
    if (savePractice) savePractice(historyEntry)
    setHistory((h) => [{ id: Date.now(), date: new Date().toISOString(), ...historyEntry }, ...h])
  }
  ...
  return (
    <div className="practice-page">
      <div className="floating-shapes-practice">
        <div className="shape-practice shape-p1"></div>
        <div className="shape-practice shape-p2"></div>
        <div className="shape-practice shape-p3"></div>
      </div>
      
      <div className="practice-header">
        <h1>Practice Speaking</h1>
        <p>Record yourself and improve your English pronunciation and fluency</p>
      </div>
      ...
      <div className="practice-container">
        <div className="practice-card">
          ...
          {lastAnalysis && !hasCompleted && (
            <div className="feedback-section">
              <div style={{color: 'var(--muted)', textAlign: 'center', padding: '1rem'}}>
                <p>Last session score: <strong style={{color: 'var(--accent)'}}>{lastAnalysis.overallScore}/100</strong></p>
              </div>
            </div>
          )}
      ...
      <div className="practice-tips">
        ...
        <ul>
          ...
          <li>Try to use varied vocabulary and complex sentences</li>
          <li>Avoid excessive filler words like "um" and "uh"</li>
          <li>Focus on pronunciation and clarity</li>
          <li>Speak for at least 2 minutes to get comprehensive feedback</li>
        </ul>
      </div>
    </div>
  )
